...
import { useGetCarsForSale, useBuyCar } from "../hooks/useCarDealer";
...
const ListedCars: React.FC = () => {
  ...
  const { setCarId, setCarPrice, buyCar, isLoading, isSuccess } = useBuyCar();

  useEffect(() => {
    if (isSuccess) {
      refreshCars();
    }
  }, [isSuccess, refreshCars]);

  const handleBuyCar = (id: number, price: bigint) => {
              ...
              <div className="p-5">
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: car.color
                          ...
                          ? "#FFFFFF"
                          : car.color.toLowerCase().includes("gray") ||
                            car.color.toLowerCase().includes("grey")
                          ? "#808080"
                ...
                >
                  ...
                  <motion.button
                    ...
                    onClick={() => handleBuyCar(car.id, car.priceWei)}
                    disabled={isLoading}
                  >
                    {isLoading ? "Processing..." : "Buy Car"}
                    <motion.svg
